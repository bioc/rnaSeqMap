...
\begin{center}
\textbf{ Vignette for v.2.7.1 - created without XMAP database access.}
\end{center}
...
f <- c("test1.bam","test2.bam","test3.bam","test4.bam","test5.bam","test6.bam")
ff <- sapply(f, function(x) system.file("extdata", x, package="rnaSeqMap"))
rs <- getBamData(rs, 1:6, files=ff)
...
<<echo=FALSE>>=
nsums <- c(25918,32577,63250,123445,126977,543654)
@
